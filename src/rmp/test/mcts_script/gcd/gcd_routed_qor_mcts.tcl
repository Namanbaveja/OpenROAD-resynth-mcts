...
set sdc_file     [expr {[info exists ::env(SDC_FILE)]     ? $::env(SDC_FILE)     : "../../benchmark_cts/new/gcd/4_cts.sdc"}]
...
file mkdir ../../qor_mcts/gcd
set file_prefix "../../qor_mcts/gcd/gcd_mcts_${seed}_pct${pct}_${iters}"
