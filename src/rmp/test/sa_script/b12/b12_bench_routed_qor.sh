#!/usr/bin/env bash
# Sweep resynth_annealing on post-CTS b12 (ASAP7).
# Run from sa_script/b12/:
#   ./b12_bench_routed_qor.sh
#   SEEDS="50 100" PERCENTAGES="10 20 30" ITERS="500" ./b12_bench_routed_qor.sh
#   OPENROAD=../../../../build/bin/openroad ./b12_bench_routed_qor.sh
set -u
...
if [[ ! -f "${TCL}" ]]; then
  echo "ERROR: ${TCL} not found; run from sa_script/b12/" >&2
  exit 1
fi
