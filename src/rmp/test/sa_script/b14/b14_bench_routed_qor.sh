#!/usr/bin/env bash
# Sweep resynth_annealing on post-CTS b14 (ASAP7).
# Run from sa_script/b14/:
#   ./b14_bench_routed_qor.sh
#   SEEDS="50 100" PERCENTAGES="10 20 30" ITERS="500" ./b14_bench_routed_qor.sh
#   OPENROAD=../../../../build/bin/openroad ./b14_bench_routed_qor.sh
set -u
...
if [[ ! -f "${TCL}" ]]; then
  echo "ERROR: ${TCL} not found; run from sa_script/b14/" >&2
  exit 1
fi
