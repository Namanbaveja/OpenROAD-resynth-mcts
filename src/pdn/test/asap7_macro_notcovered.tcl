# test for allowing macros with blockaged above top pin
source "helpers.tcl"

read_lef asap7_vias/asap7_tech_1x.lef
read_lef asap7_vias/asap7sc7p5t_27_R_1x.lef
read_lef asap7_data/fakeram7_256x32_notcovered.lef
...
set def_file [make_result_file asap7_macro_notcovered.def]
write_def $def_file
