...
read_def ../../benchmark_cts/more_design/usb_phy/4_cts.def
read_sdc ../../benchmark_cts/more_design/usb_phy/4_cts.sdc
...
file mkdir ../../qor_sa_orig/usb_phy
set file_prefix "../../qor_sa_orig/usb_phy/usb_phy_sa_${seed}_pct${pct}_${iters}"
