...
set sdc_file     [expr {[info exists ::env(SDC_FILE)]     ? $::env(SDC_FILE)     : "../../benchmark_cts/final_cts/wb_dma/4_cts.sdc"}]
...
file mkdir ../../qor_mcts/wb_dma
set file_prefix "../../qor_mcts/wb_dma/wb_dma_mcts_${seed}_pct${pct}_${iters}"
