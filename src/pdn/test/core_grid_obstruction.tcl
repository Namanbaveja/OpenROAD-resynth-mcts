# test for design with obstructions in via and routing layers
source "helpers.tcl"
...
set def_file [make_result_file core_grid_obstruction.def]
write_def $def_file
diff_files core_grid_obstruction.defok $def_file
