...
set sdc_file     [expr {[info exists ::env(SDC_FILE)]     ? $::env(SDC_FILE)     : "../../benchmark_cts/final_cts/vga_led/4_cts.sdc"}]
...
read_def ../../benchmark_cts/final_cts/vga_led/4_cts.def
read_sdc $sdc_file
...
file mkdir ../../qor_mcts/vga_led
set file_prefix "../../qor_mcts/vga_led/vga_led_mcts_${seed}_pct${pct}_${iters}"
