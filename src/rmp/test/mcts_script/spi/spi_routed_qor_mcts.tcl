...
read_def ../../benchmark_cts/Opencore/spi/4_cts.def
read_sdc ../../benchmark_cts/Opencore/spi/4_cts.sdc
...
file mkdir ../../qor_mcts/spi
set file_prefix "../../qor_mcts/spi/spi_mcts_${seed}_pct${pct}_${iters}"
