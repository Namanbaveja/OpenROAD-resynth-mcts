# Test for placing pads using place_pads with bump overlapping inst
source "helpers.tcl"
...
# Place pads
place_pads -row IO_EAST u_ddr_dq_23_io u_ddr_dq_22_io u_ddr_dq_21_io \
...
place_pads -row IO_WEST u_vss_15 u_vdd_15 u_ddr_dq_8_io u_ddr_dq_9_io \
...
place_pads -row IO_SOUTH u_ddr_dm_1_o u_ddr_dqs_n_1_io u_vzz_0 \
...
set def_file [make_result_file "place_pads_bumps_bump_overlap.def"]
write_def $def_file
diff_files $def_file "place_pads_bumps_bump_overlap.defok"
