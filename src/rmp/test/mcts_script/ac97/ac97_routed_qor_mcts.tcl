...
set sdc_file     [expr {[info exists ::env(SDC_FILE)]     ? $::env(SDC_FILE)     : "../../benchmark_cts/final_cts/ac97/4_cts.sdc"}]
...
read_def ../../benchmark_cts/final_cts/ac97/4_cts.def
read_sdc $sdc_file
...
file mkdir ../../qor_mcts/ac97
set file_prefix "../../qor_mcts/ac97/ac97_mcts_${seed}_pct${pct}_${iters}"
