...
read_sdc ../../benchmark_cts/final_cts/vga_led/4_cts.sdc
...
file mkdir ../../qor_sa_tiered/vga_led
set file_prefix "../../qor_sa_tiered/vga_led/vga_led_sa_${seed}_pct${pct}_${iters}"
