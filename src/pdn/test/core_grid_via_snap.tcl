# test for snapping via shapes to grid
source "helpers.tcl"
...
add_pdn_connect -layers {metal1 metal4} -ongrid {metal3}
add_pdn_connect -layers {metal4 metal5}

pdngen

set def_file [make_result_file core_grid_via_snap.def]
write_def $def_file
diff_files core_grid_via_snap.defok $def_file
