...
add_pdn_stripe -grid "Core" -layer metal6 -width 2.0 -pitch 15.0 -offset 7.5 -starts_with "GROUND"
...
set def_file [make_result_file core_grid_start_power_strap_ground.def]
write_def $def_file
diff_files core_grid_start_power_strap_ground.defok $def_file
