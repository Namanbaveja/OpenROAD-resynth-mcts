...
set sdc_file     [expr {[info exists ::env(SDC_FILE)]     ? $::env(SDC_FILE)     : "../../benchmark_cts/final_cts/mem_ctrl/4_cts.sdc"}]
set wns_pct      [expr {[info exists ::env(WNS_PCT)]      ? $::env(WNS_PCT)      : 10}]
set eval_mode    [expr {[info exists ::env(EVAL_MODE)]    ? $::env(EVAL_MODE)    : "tiered"}]
...
read_def ../../benchmark_cts/final_cts/mem_ctrl/4_cts.def
read_sdc $sdc_file
...
file mkdir ../../qor_mcts/mem_ctrl
set file_prefix "../../qor_mcts/mem_ctrl/mem_ctrl_mcts_${seed}_pct${pct}_${iters}"
