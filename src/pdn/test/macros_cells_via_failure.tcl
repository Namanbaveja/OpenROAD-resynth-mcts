# test for floating straps getting removed
source "helpers.tcl"

read_lef Nangate45/Nangate45.lef
read_lef nangate_macros/fakeram45_32x64.lef

read_def nangate_macros/floorplan_partial_wire_on_macro.def
####################################
# global connections
####################################
...
write_def $def_file
diff_files macros_cells_via_failure.defok $def_file
