...
add_pdn_connect -layers {M1 M3} -split_cuts {M2 1.0} -split_cuts_staggered

pdngen -report_only

pdngen

set def_file [make_result_file asap7_M1_M3_followpins_staggered.def]
write_def $def_file
diff_files asap7_M1_M3_followpins_staggered.defok $def_file
