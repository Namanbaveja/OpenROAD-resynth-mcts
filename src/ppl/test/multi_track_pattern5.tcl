...
place_pins -hor_layers M2 -ver_layers M5 -min_distance 5 \
  -min_distance_in_tracks -exclude top:* -exclude bottom:* -annealing

set def_file [make_result_file multi_track_pattern5.def]

write_def $def_file

diff_file multi_track_pattern5.defok $def_file
