...
add_pdn_connect -layers {metal1 metal4} -split_cuts {metal2 0.380} -ongrid {metal2 metal3}
add_pdn_connect -layers {metal4 metal5}

pdngen

set def_file [make_result_file core_grid_split_cuts.def]
write_def $def_file
diff_files core_grid_split_cuts.defok $def_file
