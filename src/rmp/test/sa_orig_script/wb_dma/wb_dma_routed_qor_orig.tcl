...
read_def ../../benchmark_cts/final_cts/wb_dma/4_cts.def
...
read_sdc ../../benchmark_cts/final_cts/wb_dma/4_cts.sdc
...
file mkdir ../../qor_sa_orig/wb_dma
set file_prefix "../../qor_sa_orig/wb_dma/wb_dma_sa_${seed}_pct${pct}_${iters}"
