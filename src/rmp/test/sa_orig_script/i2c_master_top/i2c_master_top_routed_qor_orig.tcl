...
read_def ../../benchmark_cts/Opencore/i2c_master_top/4_cts.def
...
read_sdc ../../benchmark_cts/Opencore/i2c_master_top/4_cts.sdc
...
puts ""
# ---- post-restructure: place + parasitic + repair (OpenROAD standard flow) ----
puts ">>> detailed_placement (legalize unplaced cells from resynth_annealing)"
detailed_placement
puts ">>> estimate_parasitics"
estimate_parasitics -placement
puts ">>> repair_timing -setup (resize/buffer restructured cone)"
repair_timing -setup
puts ">>> detailed_placement (legalize cells inserted by repair_timing)"
detailed_placement
puts ""
...
file mkdir ../../qor_sa_orig/i2c_master_top
set file_prefix "../../qor_sa_orig/i2c_master_top/i2c_master_top_sa_${seed}_pct${pct}_${iters}"
