...
set export_files [expr {[info exists ::env(EXPORT_FILES)] && $::env(EXPORT_FILES) eq "1"}]
...
read_def ../../benchmark_cts/more_design/simple_spi_top/4_cts.def
read_sdc ../../benchmark_cts/more_design/simple_spi_top/4_cts.sdc
...
if { $export_files } {
  set file_prefix "simple_spi_top_mcts_${seed}_pct${pct}_${iters}"
