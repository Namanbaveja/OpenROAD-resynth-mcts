...
set sdc_file     [expr {[info exists ::env(SDC_FILE)]     ? $::env(SDC_FILE)     : "../../benchmark_cts/final_cts/ibex/4_cts.sdc"}]
...
read_def ../../benchmark_cts/final_cts/ibex/4_cts.def
read_sdc $sdc_file
...
file mkdir ../../qor_mcts/ibex
set file_prefix "../../qor_mcts/ibex/ibex_mcts_${seed}_pct${pct}_${iters}"
