...
set_io_pin_constraint -region bottom:* -pin_names {req_msg[0] req_msg[1]
  req_msg[2] req_msg[3] req_msg[4] req_msg[5] req_msg[6] req_msg[7] req_msg[8]
  req_msg[9] req_msg[10]}
