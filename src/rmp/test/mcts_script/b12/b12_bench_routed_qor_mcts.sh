#!/usr/bin/env bash
# Sweep resynth_mcts on post-CTS b12 (ASAP7).
# Run from mcts_script/b12/:
#   ./b12_bench_routed_qor_mcts.sh
#   SEEDS="50 100" PERCENTAGES="10 20 30" ITERS="500" ./b12_bench_routed_qor_mcts.sh
#   OPENROAD=../../../../build/bin/openroad ./b12_bench_routed_qor_mcts.sh
set -u
...
TCL="${TCL:-b12_routed_qor_mcts.tcl}"
...
if [[ ! -f "${TCL}" ]]; then
  echo "ERROR: ${TCL} not found; run from mcts_script/b12/" >&2
  exit 1
fi
