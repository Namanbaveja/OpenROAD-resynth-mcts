# test for define_pdn_grid -macro -grid_over_pg_pins
source "helpers.tcl"
...
define_pdn_grid -macro -name "sram" -cells "fakeram45_64x32" -grid_over_pg_pins
...
set def_file [make_result_file macros_cells_extend_boundary.def]
write_def $def_file
diff_files macros_cells_extend_boundary.defok $def_file
