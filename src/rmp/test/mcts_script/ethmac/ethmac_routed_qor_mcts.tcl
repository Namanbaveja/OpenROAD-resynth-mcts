...
set sdc_file     [expr {[info exists ::env(SDC_FILE)]     ? $::env(SDC_FILE)     : "../../benchmark_cts/final_cts/ethmac/4_cts.sdc"}]
...
file mkdir ../../qor_mcts/ethmac
set file_prefix "../../qor_mcts/ethmac/ethmac_mcts_${seed}_pct${pct}_${iters}"
